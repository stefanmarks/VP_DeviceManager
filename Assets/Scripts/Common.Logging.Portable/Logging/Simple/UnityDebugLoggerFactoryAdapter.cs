...
{
	/// <summary>
	/// Factory for creating <see cref="ILog" /> instances that write data using <see cref="UnityEngine.Debug" />.
	/// </summary>
	/// <remarks>
	/// <example>
	...
	///   &lt;common&gt;
	///     &lt;logging&gt;
	///       &lt;factoryAdapter type=&quot;Common.Logging.Simple.UnityDebugLoggerFactoryAdapter, Common.Logging&quot;&gt;
	...
	public class UnityDebugLoggerFactoryAdapter : AbstractSimpleLoggerFactoryAdapter
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="UnityDebugLoggerFactoryAdapter"/> class using default 
		/// settings.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="UnityDebugLoggerFactoryAdapter"/> class.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		public UnityDebugLoggerFactoryAdapter(LogLevel level, bool showDateTime, bool showLogName, bool showLevel, string dateTimeFormat) 
			: base(level, showDateTime, showLogName, showLevel, dateTimeFormat)
		{ }

		/// <summary>
		/// Creates a new <see cref="UnityDebugLogger"/> instance.
		/// </summary>
		protected override ILog CreateLogger(string name, LogLevel level, bool showLevel, bool showDateTime, bool showLogName, string dateTimeFormat)
		{
			ILog log = new UnityDebugLogger(name, level, showLevel, showDateTime, showLogName, dateTimeFormat);
			return log;
		}
	}
}
