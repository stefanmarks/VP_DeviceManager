...
namespace Common.Logging.Simple
{
	...
	public class UnityDebugLogger : AbstractSimpleLogger
	{
		/// <summary>
		...
		public UnityDebugLogger(string logName, LogLevel logLevel, bool showLevel, bool showDateTime, bool showLogName, string dateTimeFormat)
