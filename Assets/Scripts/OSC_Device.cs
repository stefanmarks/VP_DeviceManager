...
public class OSC_Device : MonoBehaviour
{
	...
	public void Update()
	{
		...
		if (m_io != null)
		{
			m_io1.Value = m_io.Input1On; m_io1.SendUpdate();
			m_io2.Value = m_io.Input2On; m_io2.SendUpdate();
			m_io3.Value = m_io.Input3On; m_io3.SendUpdate();
			m_io4.Value = m_io.Input4On; m_io4.SendUpdate();
		}
	}
